...
import { addProductToCard } from "../slice/productsSlice";
  ...
  return (
    <div className="rounded-xl overflow-hidden border-2 border-blue-500">
      ...
      <div className="py-3 px-4">
        ...
        >
          Instock : {product?.inStock ? "HAVE" : "ENDED" || "None"}
        </div>
        <button
          className="w-full mt-2 bg-blue-500 text-white text-lg py-1 rounded-xl"
          onClick={(e) => {
